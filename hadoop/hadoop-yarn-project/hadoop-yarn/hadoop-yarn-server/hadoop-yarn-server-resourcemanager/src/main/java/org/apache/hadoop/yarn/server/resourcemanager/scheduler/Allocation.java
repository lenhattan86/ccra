...
public class Allocation {
	...
	public boolean isEmpty() {
		return containers.size() == 0 && resourceLimit.getMemory() == 0
		    && resourceLimit.getVirtualCores() == 0 && strictContainers==null && fungibleContainers==null && fungibleResources==null;
	}
	// iglf: END
}
