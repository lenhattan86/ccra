...
public class BoPFSchedulerPolicy extends SchedulingPolicy {
  ...
  private ThisComparator comparator = new ThisComparator();

  private static final Log LOG = LogFactory.getLog(BoPFSchedulerPolicy.class);


  public static final boolean DEBUG = true; // enabling this can resulting failing the data nodes.
   ...
   */
  static class ThisComparator implements Comparator<Schedulable>, Serializable {
