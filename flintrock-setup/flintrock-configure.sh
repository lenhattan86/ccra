...
flintrock run-command $cluster 'cp /home/ec2-user/spark/yarn/spark-2.0.0-preview-yarn-shuffle.jar /home/ec2-user/hadoop/share/hadoop/yarn/'
...
flintrock run-command $cluster 'chmod +x /home/ec2-user/perform_experiment.sh'
