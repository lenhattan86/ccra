      6, 7, 4, 3, 3, 4, 5, 3, 4, 2, 6, 4, 4, 3, 3, 3, 4, 5, 3, 3, 6, 2, 5, 3, 2, 2, 2, 4, 1, 1, 2, 6, 2, 4, 5, 2, 2, 4,
      5, 3, 3, 2, 3, 3, 4, 4, 2, 4, 3, 3, 6, 5, 1, 5, 3, 4, 2, 2, 2, 3, 5, 5, 1, 3, 5, 4, 7, 6, 4, 3, 1, 3, 5, 4, 3, 3,
      5, 4, 5, 5, 2, 5, 2, 3, 2, 6, 4, 4, 6, 5, 7, 6, 2, 1, 5, 4 };
  static final int[] RED_MEM = { 2048, 7168, 3072, 4096, 2048, 5120, 5120, 4096, 2048, 7168, 6144, 6144, 5120, 3072,
      4096, 5120, 4096, 6144, 3072, 4096, 3072, 4096, 5120, 2048, 6144, 5120, 3072, 7168, 5120, 3072, 1024, 7168, 7168,
      1024, 3072, 1024, 4096, 2048, 6144, 2048, 5120, 2048, 4096, 3072, 3072, 4096, 2048, 1024, 6144, 5120, 6144, 5120,
      4096, 2048, 5120, 5120, 2048, 2048, 5120, 7168, 5120, 2048, 3072, 4096, 1024, 3072, 6144, 4096, 6144, 3072, 4096,
      3072, 5120, 4096, 4096, 2048, 3072, 4096, 4096, 3072, 5120, 3072, 3072, 7168, 1024, 1024, 3072, 6144, 3072, 4096,
      3072, 4096, 3072, 7168, 6144, 5120, 7168, 5120, 2048, 5120, 3072, 3072, 1024, 2048, 7168, 5120, 2048, 5120, 6144,
      4096, 6144, 2048, 4096, 1024, 4096, 5120, 6144, 6144, 6144, 1024, 3072, 5120, 2048, 5120, 2048, 2048, 6144, 1024,
      3072, 5120, 2048, 2048, 3072, 7168, 4096, 2048, 5120, 6144, 1024, 5120, 7168, 2048, 5120, 2048, 6144, 5120, 3072,
      6144, 6144, 5120, 3072, 4096, 2048, 6144, 2048, 3072, 3072, 3072, 6144, 2048, 3072, 3072, 3072, 3072, 3072, 5120,
      5120, 6144, 1024, 2048, 3072, 3072, 2048, 2048, 5120, 4096, 2048, 2048, 6144, 4096, 6144, 2048, 5120, 7168, 4096,
      5120, 5120, 4096, 5120, 1024, 2048, 2048, 2048, 5120, 5120, 4096, 6144, 3072, 2048, 6144 };
  ...
  public static void printTezBatchUsingTraces(ArrayList<String> dagIds, String scriptDirPath, String workloadOutputDir,
      String hadoopCommand, String pathToWorkGenJar, int numBatchJob, int NUM_QUEUES) throws Exception {
    ...
    if (dagIds.size() > 0) {
      ...
      if (NUM_QUEUES > 0)
        for (int i = 0; i < numBatchJob; i++) {
          FileWriter runFile = new FileWriter(scriptDirPath + "/run-batch-" + i + ".sh");

          int queueIdx = i % NUM_QUEUES;
          toWrite = "cd ~/ \n";
          runFile.write(toWrite.toCharArray(), 0, toWrite.length());

          toWrite = "" + hadoopCommand + " jar " + pathToWorkGenJar + " " + dagIds.get(i) + " batch" + queueIdx + " >> "
              + workloadOutputDir + "/batch-" + i + ".txt 2>> " + workloadOutputDir + "/batch-" + i + ".txt ";
          ...
          Runtime.getRuntime().exec("chmod +x " + scriptDirPath + "/run-batch-" + i + ".sh");
      ...
      // works for linux type systems only
      Runtime.getRuntime().exec("chmod +x " + scriptDirPath + "/batches-all.sh");
    }
  }

  public static void printTezBurstyJobs(ArrayList<String> dagIds, String scriptDirPath, String workloadOutputDir,
      String hadoopCommand, String pathToWorkGenJar, int arrivalPeriod, int numInteractiveJobs, int NUM_QUEUES,
      int burstyStartTime, int queueId, int startJobIdx) throws Exception {
    if (dagIds.size() > 0) {
      String toWrite = "";

      FileWriter runAllJobs = new FileWriter(scriptDirPath + "/interactives-queue-" + queueId + ".sh");
      ...
      for (int i = 0; i < numInteractiveJobs; i++) {
        ...
        FileWriter runFile = new FileWriter(scriptDirPath + "/run-interactive-" + i + "_" + queueId + ".sh");

        toWrite = "cd ~/ \n";
        runFile.write(toWrite.toCharArray(), 0, toWrite.length());

        int idx = i + startJobIdx;
        toWrite = "" + hadoopCommand + " jar " + pathToWorkGenJar + " " + dagIds.get(idx) + " bursty" + queueId + " >> "
            + workloadOutputDir + "/interactive-" + i + "_" + queueId + ".txt 2>> " + workloadOutputDir
            + "/interactive-" + i + "_" + queueId + ".txt ";
        ...
        // works for linux type systems only
        Runtime.getRuntime().exec("chmod +x " + scriptDirPath + "/run-interactive-" + i + "_" + queueId + ".sh");

        toWrite = "./run-interactive-" + i + "_" + queueId + ".sh &\n";
        runAllJobs.write(toWrite.toCharArray(), 0, toWrite.length());
      ...
      // works for linux type systems only
      Runtime.getRuntime().exec("chmod +x " + scriptDirPath + "/interactives-queue-" + queueId + ".sh");
    }
  }
   ...
   *
   */
  public static void printMRBatchUsingTraces(ArrayList<ArrayList<String>> workloadData, int clusterSizeRaw,
      ...
      String hadoopCommand, String pathToWorkGenJar, String pathToWorkGenConf, int numBatchJob, int NUM_QUEUES,
    ...
    if (workloadData.size() > 0) {
      ...
      for (int i = 0; i < numBatchJob; i++) {
        ...
        while (inputCopy > 0) {
          ...
          while (alreadySampled) {
            if (inputPartitionSamples.size() >= inputPartitionCount) {
              ...
              System.err.println("Total data size is " + (((long) inputPartitionSize) * ((long) inputPartitionCount))
                  + " bytes < " + input + " bytes.");
        ...
        FileWriter inputPathFile = new FileWriter(scriptDirPath + "/inputPath-batch-" + i + ".txt");
        String inputPath = "";
        ...
        if (totalDataPerReduce > 0) {
          ...
          toWrite = "" + hadoopCommand + " jar " + pathToWorkGenJar + " org.apache.hadoop.examples.WorkGen -conf "
              + pathToWorkGenConf + " " + "-m " + numMaps + " " + "-r " + numReduces + " " + inputPath + " "
              + outputPath + " -queue " + "root.batch" + queueIdx + " -map.vcores " + MAP_VCORES[i] + " -red.vcores "
              + RED_VCORES[i] + " -map.memory " + MAP_MEM[i] + " -red.memory " + RED_MEM[i] + " " + SIRatio + " "
              + OSRatio + " >> " + workloadOutputDir + "/batch-" + i + ".txt 2>> " + workloadOutputDir + "/batch-" + i
              + ".txt ";
        } else {
          toWrite = "" + hadoopCommand + " jar " + pathToWorkGenJar + " org.apache.hadoop.examples.WorkGen -conf "
              + pathToWorkGenConf + " " + "-m " + numMaps + " " + inputPath + " " + outputPath + " -queue "
              + "root.batch" + queueIdx + " -map.vcores " + MAP_VCORES[i] + " -red.vcores " + RED_VCORES[i]
              + " -map.memory " + MAP_MEM[i] + " -red.memory " + RED_MEM[queueIdx] + " " + SIRatio + " " + OSRatio
              + " >> " + workloadOutputDir + "/batch-" + queueIdx + ".txt 2>> " + workloadOutputDir + "/batch-"
              + queueIdx + ".txt ";
        }
  ...
  public static void printMRBurstyJobs(ArrayList<ArrayList<String>> workloadData, int clusterSizeRaw,
      int clusterSizeWorkload, int inputPartitionSize, int inputPartitionCount, String scriptDirPath,
      String hdfsInputDir, String hdfsOutputPrefix, long totalDataPerReduce, String workloadOutputDir,
    ...
    if (workloadData.size() > 0) {
      ...
      FileWriter runAllJobs = new FileWriter(scriptDirPath + "/interactives-all.sh");
      ...
      for (int i = 0; i < numInteractiveJobs; i++) {
        ...
        FileWriter inputPathFile = new FileWriter(scriptDirPath + "/inputPath-interactive-" + i + ".txt");
        String inputPath = "";
        for (int j = 0; j < inputPartitionSamples.size(); j++) {
          inputPath = (hdfsInputDir + "/part-" + String.format("%05d", inputPartitionSamples.get(j)));
          if (j != (inputPartitionSamples.size() - 1))
        ...
        for (int k = 0; k < NUM_QUEUES; k++) {
          ...
          if (totalDataPerReduce > 0) {
            ...
            toWrite = "" + hadoopCommand + " jar " + pathToWorkGenJar + " org.apache.hadoop.examples.WorkGen -conf "
                ...
                + "bursty" + k + " -map.vcores " + BURSTY_CPU + " -red.vcores " + BURSTY_CPU
                // + " -map.memory " + MAP_MEM[idx + k] + " -red.memory " +
                // RED_MEM[idx + k] + " " + SIRatio + " "
                + " -map.memory " + BURSTY_MEM + " -red.memory " + BURSTY_MEM + " " + SIRatio + " " + OSRatio + " >> "
                + workloadOutputDir + "/interactive-" + i + "_" + k + ".txt 2>> " + workloadOutputDir + "/interactive-"
                + i + "_" + k + ".txt ";
          } else {
            toWrite = "" + hadoopCommand + " jar " + pathToWorkGenJar + " org.apache.hadoop.examples.WorkGen -conf "
                + pathToWorkGenConf + " " + "-m " + numMaps + " " + inputPath + " " + mOutputPath + " -queue "
                + "bursty" + k
                // + " -map.vcores " + MAP_VCORES[idx + k] + " -red.vcores " +
                // RED_VCORES[idx + k] + " -map.memory "
                + " -map.vcores " + BURSTY_CPU + " -red.vcores " + BURSTY_CPU + " -map.memory "
                // + MAP_MEM[idx + k] + " -red.memory " + RED_MEM[idx + k] + " "
                // + SIRatio + " " + OSRatio + " >> "
                + BURSTY_MEM + " -red.memory " + BURSTY_MEM + " " + SIRatio + " " + OSRatio + " >> " + workloadOutputDir
                + "/interactive-" + i + "_" + k + ".txt 2>> " + workloadOutputDir + "/interactive-" + i + "_" + k
                + ".txt ";
          }
      ...
      // works for linux type systems only
      Runtime.getRuntime().exec("chmod +x " + scriptDirPath + "/interactives-all.sh");
    }
  }
  ...
  public static void main(String args[]) throws Exception {
    ...
    if (args.length < 10) {
      ...
      System.out.println("  [number of machines in the cluster where the workload will be run]");
    ...
    if (!IS_TEZ) {
      int burstyAppNum = 15;
      printMRBatchUsingTraces(workloadData, clusterSizeRaw, clusterSizeWorkload, inputPartitionSize,
          inputPartitionCount, scriptDirPath, hdfsInputDir, hdfsOutputPrefix, totalDataPerReduce, workloadOutputDir,
          hadoopCommand, pathToWorkGenJar, pathToWorkGenConf, burstyAppNum * 6, 3, (int) (256 * 0.8)); // should

      printMRBurstyJobs(workloadData, clusterSizeRaw, clusterSizeWorkload, inputPartitionSize, inputPartitionCount,
...
//       int[] burstyStartTimes = { 250, 300, 350 };
      ...
      for (int i = 0; i < burstyAppNum * numOfBurstyQueues; i++)
        burstyIds.add(String.valueOf(i));

      printTezBatchUsingTraces(batchIds, scriptDirPath, workloadOutputDir, hadoopCommand, pathToWorkGenJar, batchAppNum,
          numOfBatchQueues);
      
      for (int qIdx = 0; qIdx < numOfBurstyQueues; qIdx++) {
        int startJobIdx = qIdx * burstyAppNum;
        printTezBurstyJobs(burstyIds, scriptDirPath, workloadOutputDir, hadoopCommand, pathToWorkGenJar,
            burstyPeriods[qIdx], burstyAppNum, numOfBurstyQueues, burstyStartTimes[qIdx], qIdx, startJobIdx);
      }
    }
