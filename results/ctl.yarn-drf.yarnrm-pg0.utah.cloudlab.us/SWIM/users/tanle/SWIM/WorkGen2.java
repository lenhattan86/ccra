 ...
 * Comments here
 */
public class WorkGen2 extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		JobConf jobConf = new JobConf(getConf(), WorkGen2.class);
...
//		
//		jobConf.setLong(MRJobConfig.MAP_CPU_VCORES, 2);
//		jobConf.setLong(MRJobConfig.REDUCE_CPU_VCORES, 2);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new WorkGen2(), args);
		System.exit(res);
	}
