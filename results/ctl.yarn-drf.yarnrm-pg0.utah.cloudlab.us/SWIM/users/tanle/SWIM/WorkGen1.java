 ...
 * Comments here
 */
public class WorkGen1 extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		JobConf jobConf = new JobConf(getConf(), WorkGen1.class);
...
//          vcores = Integer.parseInt(args[++i]);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new WorkGen1(), args);
		System.exit(res);
	}
