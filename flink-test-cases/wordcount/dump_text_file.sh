...
~/hadoop/bin/hadoop fs -mkdir hdfs:///wordcount
~/hadoop/bin/hadoop fs -rmr -skipTrash hdfs:///wordcount/app01.txt
#~/hadoop/bin/hadoop fs -rmr -skipTrash hdfs:///wordcount/app02.txt
#~/hadoop/bin/hadoop fs -rmr -skipTrash hdfs:///wordcount/app03.txt

~/hadoop/bin/hadoop fs -copyFromLocal -f /dev/app01.txt hdfs:///wordcount/app01.txt
#~/hadoop/bin/hadoop fs -copyFromLocal -f /dev/app02.txt hdfs:///wordcount/app02.txt
#~/hadoop/bin/hadoop fs -copyFromLocal -f /dev/app03.txt hdfs:///wordcount/app03.txt
