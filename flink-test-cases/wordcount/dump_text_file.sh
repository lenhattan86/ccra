...
# 11 -> 19M
# 2
for i in {1..14}; do sudo cat /dev/app02.txt /dev/app02.txt > temp2.txt && sudo mv temp2.txt /dev/app02.txt; done

sudo cp book01.t /dev/app03.txt
for i in {1..9}; do sudo cat /dev/app03.txt /dev/app03.txt > temp3.txt && sudo mv temp3.txt /dev/app03.txt; done
