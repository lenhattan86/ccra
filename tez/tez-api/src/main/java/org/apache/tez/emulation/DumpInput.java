 ...
 */
public class DumpInput extends AbstractLogicalInput {
  private static final Logger LOG = LoggerFactory
      .getLogger(DumpInput.class);
  ...
  public DumpInput(InputContext inputContext, int numPhysicalInputs) {
...
/*    this.completedInputVersion = new int[numPhysicalInputs];
  ...
  public static InputDescriptor getInputDesc(UserPayload payload) {
    InputDescriptor desc = InputDescriptor.create(DumpInput.class.getName());
/*    if (payload != null) {
