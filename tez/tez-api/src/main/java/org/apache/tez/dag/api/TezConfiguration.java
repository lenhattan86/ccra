...
public class TezConfiguration extends Configuration {
   ...
   * This improves performance by not incurring recurring launch overheads.
   */
/*  public static final String TEZ_AM_GRAPHENE_ENABLED = TEZ_AM_PREFIX
      + "graphene.enabled";
  public static final boolean TEZ_AM_GRAPHENE_ENABLED_DEFAULT = false;
*/  
  // enable to update resources used by a task
  public static final String TEZ_ENABLE_VERTEX_PROFILE_UPDATE = "tez.graphene.log.profiles.enabled";
  public static final boolean TEZ_ENABLE_VERTEX_PROFILE_UPDATE_DEFAULT = false;
  
  public static final String TEZ_ENABLE_VERTEX_PROFILE_SET = "tez.graphene.log.profiles.update.enabled";
  ...
  public static final boolean TEZ_GRAPHENE_EXEC_LOGGING_INFO_ENABLED_DEFAULT = false;
  
  // if enable to log dag.sim used for simulation
  public static final String TEZ_GRAPHENE_SIM_LOGGING_INFO_ENABLED = "tez.graphene.log.simulation.enabled";
  public static final boolean TEZ_GRAPHENE_SIM_LOGGING_INFO_ENABLED_DEFAULT = false;
