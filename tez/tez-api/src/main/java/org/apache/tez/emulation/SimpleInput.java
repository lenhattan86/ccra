 ...
 */
public class SimpleInput extends AbstractLogicalInput {
  private static final Logger LOG = LoggerFactory
      .getLogger(SimpleInput.class);
  ...
  public SimpleInput(InputContext inputContext, int numPhysicalInputs) {
  ...
  public static InputDescriptor getInputDesc(UserPayload payload) {
    InputDescriptor desc = InputDescriptor.create(SimpleInput.class.getName());
    if (payload != null) {
