...
public class SimpleOutput extends AbstractLogicalOutput {
  private static final Logger LOG = LoggerFactory.getLogger(SimpleOutput.class);

  public static final String COUNTER_NAME = "TestOutput";
  public SimpleOutput(OutputContext outputContext, int numPhysicalOutputs) {
    super(outputContext, numPhysicalOutputs);
  }

  public static OutputDescriptor getOutputDesc(UserPayload payload) {
    OutputDescriptor desc = OutputDescriptor.create(SimpleOutput.class.getName());
    if (payload != null) {
