...
public class DumpOutput extends AbstractLogicalOutput {
  private static final Logger LOG = LoggerFactory.getLogger(DumpOutput.class);

  public static final String COUNTER_NAME = "TestOutput";
  public DumpOutput(OutputContext outputContext, int numPhysicalOutputs) {
    super(outputContext, numPhysicalOutputs);
  }

  public static OutputDescriptor getOutputDesc(UserPayload payload) {
    OutputDescriptor desc = OutputDescriptor.create(DumpOutput.class.getName());
    return desc;
  }
